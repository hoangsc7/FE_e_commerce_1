export const CREATE_ORDER_REQUEST = "CRETE_ORDER_REQUEST";
export const CREATE_ORDER_SUCCESS = "CRETE_ORDER_SUCCESS";
export const CREATE_ORDER_FAILURE = "CRETE_ORDER_FAILURE";
