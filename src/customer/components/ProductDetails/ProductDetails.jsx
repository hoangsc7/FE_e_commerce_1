    ...
    <div className=" bg-white lg:px-20 ">
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">56549 Ratings</p>
        ...
        <section>
          ...
          <div className="w border border-gray-200 p-5">
            <Grid container spacing={7} className="w-full">
              <Grid item xs={7} className="w-[55%]">
              ...
              <Grid item xs={5} className="w-[40%]">
                ...
                <Box className="w-full mt-4">
                  <Grid
                    container
                    spacing={0}
                    className=" items-center gap-4 mb-2"
                    alignItems="center"
                  >
                    <Grid container className="w-[20%]">
                      <p>Excellent</p>
                    </Grid>
                    <Grid container className="w-[80%] ">
                      <LinearProgress
                        variant="determinate"
                        value={35}
                        color="success"
